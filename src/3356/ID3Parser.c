 ...
 *******************************************************************************/
Boolean
ID3Open(char* fileName, ID3Stream* id3Str)
{
	LongWord fileSize;
...
/*******************************************************************************
 * Function:	ID3ReadTagData
 * Summary:		
 *				
 *******************************************************************************/
Boolean
ID3ReadTagData(ID3Stream* id3Str, Byte* buf, Word bufSize)
{
	long prevPos;
	int res;
	Word bytesToRead;
 ...
 *******************************************************************************/
static Boolean
locateHeader(ID3Stream* id3Str, LongWord fileSize)
{
	Byte buf[10];
	int res;
...
/*******************************************************************************
 * Function:	skipExtendedHeader
 * Summary:		
 *				
 *******************************************************************************/
static Boolean
skipExtendedHeader(ID3Stream* id3Str)
{
...
/*******************************************************************************
 * Function:	syncsafeToNormal
 * Summary:		
 *				
 *******************************************************************************/
static LongWord
syncsafeToNormal(Byte * b)
{
	return ((b[3] & 0x7f) <<  0) + 
	       ((b[2] & 0x7f) <<  7) + 
	       ((b[1] & 0x7f) << 14) + 
