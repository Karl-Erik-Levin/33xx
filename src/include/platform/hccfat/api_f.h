...
#define FN_MAXPATH	128		/* maximum allowed filename or pathname */
...
#ifdef FILEOPENOPT
#define f_openopt(startcluster,filesize) fm_openopt(startcluster,filesize)
#define f_getfilesize(filehandle) fm_getfilesize(filehandle)
#endif
...
#ifdef FILEOPENOPT
extern FN_FILE *fm_openopt(const unsigned long startcluster,const unsigned long filesize);
extern unsigned long fm_getfilesize(F_FILE *Filehandle);
#endif	
