...
/* DATATON PICKUP */
#ifdef FILEOPENOPT
extern FN_FILE *fn_openopt(F_MULTI *fm,const unsigned long startcluster,const unsigned long filesize);
extern unsigned long fn_getfilesize(F_MULTI *fm, FN_FILE *filehandle);
#endif
